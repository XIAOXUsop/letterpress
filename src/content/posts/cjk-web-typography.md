...
但**没有 Bold**；思源黑体有 300 到 900 的完整字重；微软雅黑主要就是 400 和 700。
...
中文部分落到苹方 / 微软雅黑的 700，两者视觉重量相当。
（反过来，写 500 的话中文会掉到 **400**——比正文还轻，标题反而立不住。）
...
`em` 等于字号，与字体无关。一个汉字约 1em 宽，一个西文字母平均约 0.5em 宽。于是：

- 中文：约 34 个字 ✅（落在 30–40 的理想区间）
- 西文：约 68 个字符 ✅（落在 45–75 的理想区间）

**一个值同时满足两种文字的舒适区，而且不随字体变。** 这是
`--measure: 34em` 的由来。
