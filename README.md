...
| 站内 JS | 文章页 **0 个文件**；只有搜索页按需加载同源 Pagefind 1.5.2，实测运行时资源 **6 个 js**、未压缩共 **430 KB**（2026-09-24 复测；此前写的「17 个文件、146 KB gzip」在当前环境**已无法复现**，pagefind 版本未变而产物结构对不上，故改为可复现的口径） |
